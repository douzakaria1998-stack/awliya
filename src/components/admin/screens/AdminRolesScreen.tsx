...
export function AdminRolesScreen() {
  ...
  return (
    <div className={`w-full select-none ${isRTL ? 'text-right' : 'text-left'}`}>
          ...
          <table className="w-full text-xs sm:text-sm text-right">
            <thead className="bg-slate-50 dark:bg-slate-900/60 border-b border-slate-200/80 dark:border-slate-800 text-slate-400 font-bold">
              <tr>
                ...
                <th style={{ paddingTop: '18px', paddingBottom: '18px', paddingLeft: '20px', paddingRight: '20px' }} className="text-center whitespace-nowrap">الحالة</th>
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {adminUsers.map((u) => (
                ...
                >
                  <td style={{ paddingTop: '18px', paddingBottom: '18px', paddingRight: '36px', paddingLeft: '20px' }} className="font-black text-slate-900 dark:text-white whitespace-nowrap">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <div className="font-bold text-slate-900 dark:text-white text-xs sm:text-sm">{u.fullNameAr}</div>
                        <div className="text-[11px] text-slate-400 font-medium">{u.fullNameEn}</div>
                      </div>
                    </div>
                  </td>
                  <td style={{ paddingTop: '18px', paddingBottom: '18px', paddingLeft: '20px', paddingRight: '20px' }} className="text-center font-mono font-bold text-purple-600 dark:text-purple-400 whitespace-nowrap">
                    @{u.username}
                  </td>
                  ...
                  <td style={{ paddingTop: '18px', paddingBottom: '18px', paddingLeft: '20px', paddingRight: '20px' }} className="text-center text-slate-600 dark:text-slate-300 font-medium whitespace-nowrap">
                    {u.departmentAr}
                  </td>
                  <td style={{ paddingTop: '18px', paddingBottom: '18px', paddingLeft: '20px', paddingRight: '20px' }} className="text-center font-mono text-slate-500 dark:text-slate-400 text-xs whitespace-nowrap">
                    {u.email}
                  </td>
                  <td style={{ paddingTop: '18px', paddingBottom: '18px', paddingLeft: '20px', paddingRight: '20px' }} className="text-center whitespace-nowrap">
                    <span
                    ...
                    >
                      {u.status === 'active' ? 'نشط' : u.status === 'suspended' ? 'موقوف' : 'معطل'}
                    </span>
                  </td>
                  <td
                    style={{ paddingTop: '18px', paddingBottom: '18px', paddingLeft: '36px', paddingRight: '20px' }}
                  ...
                  >
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-purple-50 dark:bg-purple-950/60 hover:bg-purple-100 dark:hover:bg-purple-900/60 text-purple-700 dark:text-purple-300 font-bold text-xs border border-purple-200/80 dark:border-purple-800/80 shadow-2xs transition-all hover:scale-105 active:scale-95 cursor-pointer"
                      title={language === 'ar' ? 'تعديل بيانات الحساب وتغيير كلمة المرور' : 'Edit account & change password'}
                    >
                      <Edit3 size={13} />
                      <span>{language === 'ar' ? 'تعديل الحساب' : 'Edit'}</span>
                    </button>
                  </td>
                </tr>
              ))}
      ...
      {/* Admin User Edit / Password Change / Delete Modal */}
      <AdminUserDetailModal
        adminUser={selectedEditUser}
