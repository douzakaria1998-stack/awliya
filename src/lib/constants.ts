...
export const STORAGE_KEYS = {
  AUTH_USER: 'awliya_auth_user_v11',
  AUTH_STATUS: 'awliya_auth_status_v11',
  STUDENTS_LIST: 'awliya_students_list_v11',
  ACTIVE_STUDENT_ID: 'awliya_active_student_id_v11',
  CURRENT_LEVEL: 'awliya_current_level_v11',
  NOTIFICATIONS: 'awliya_notifications_v11',
  NOTIFICATION_SETTINGS: 'awliya_notification_settings_v11',
  HOMEWORK: 'awliya_homework_v11',
  ATTENDANCE: 'awliya_attendance_v11',
  ASSESSMENTS: 'awliya_assessments_v11',
  FEEDBACK: 'awliya_feedback_v11',
  FEES: 'awliya_fees_v11',
  PAYMENTS: 'awliya_payments_v11',
  THEME_MODE: 'awliya_theme_mode_v11',
  ACTIVE_TAB: 'awliya_active_tab_v11',
  ACTIVE_PERFORMANCE_SUBTAB: 'awliya_active_perf_subtab_v11',
  ADMIN_PARENTS: 'myschool_admin_parents_v11',
  ADMIN_STUDENTS: 'myschool_admin_students_v11',
  ADMIN_CURRICULA: 'myschool_admin_curricula_v11',
  ADMIN_LESSON_PROGRESS: 'myschool_admin_lesson_progress_v11',
  ADMIN_STUDENT_LEVEL_SCORES: 'myschool_admin_student_level_scores_v11',
  ADMIN_ATTENDANCE: 'myschool_admin_attendance_v11',
  ADMIN_HOMEWORK: 'myschool_admin_homework_v11',
  ADMIN_ASSESSMENTS: 'myschool_admin_assessments_v11',
  ADMIN_FEEDBACK: 'myschool_admin_feedback_v11',
} as const;
