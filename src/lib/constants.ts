...
export const STORAGE_KEYS = {
  AUTH_USER: 'awliya_auth_user_v10',
  AUTH_STATUS: 'awliya_auth_status_v10',
  STUDENTS_LIST: 'awliya_students_list_v10',
  ACTIVE_STUDENT_ID: 'awliya_active_student_id_v10',
  CURRENT_LEVEL: 'awliya_current_level_v10',
  NOTIFICATIONS: 'awliya_notifications_v10',
  NOTIFICATION_SETTINGS: 'awliya_notification_settings_v10',
  HOMEWORK: 'awliya_homework_v10',
  ATTENDANCE: 'awliya_attendance_v10',
  ASSESSMENTS: 'awliya_assessments_v10',
  FEEDBACK: 'awliya_feedback_v10',
  FEES: 'awliya_fees_v10',
  PAYMENTS: 'awliya_payments_v10',
  THEME_MODE: 'awliya_theme_mode_v10',
  VIEWPORT_MODE: 'awliya_viewport_mode_v10',
  ADMIN_PARENTS: 'myschool_admin_parents_v10',
  ADMIN_STUDENTS: 'myschool_admin_students_v10',
  ADMIN_CURRICULA: 'myschool_admin_curricula_v10',
  ADMIN_LESSON_PROGRESS: 'myschool_admin_lesson_progress_v10',
  ADMIN_STUDENT_LEVEL_SCORES: 'myschool_admin_student_level_scores_v10',
  ADMIN_ATTENDANCE: 'myschool_admin_attendance_v10',
} as const;
