...
const ADMIN_STORAGE_KEYS = {
  CURRENT_USER_ID: 'myschool_admin_user_id_v10',
  ADMIN_USERS: 'myschool_admin_users_v10',
  STUDENTS: 'myschool_admin_students_v10',
  PARENTS: 'myschool_admin_parents_v10',
  TEACHERS: 'myschool_admin_teachers_v10',
  GROUPS: 'myschool_admin_groups_v10',
  CURRICULA: 'myschool_admin_curricula_v10',
  ATTENDANCE: 'myschool_admin_attendance_v10',
  HOMEWORK: 'myschool_admin_homework_v10',
  ASSESSMENTS: 'myschool_admin_assessments_v10',
  FEEDBACK: 'myschool_admin_feedback_v10',
  PERMISSIONS: 'myschool_admin_permissions_v10',
  AUDIT_LOGS: 'myschool_admin_audit_logs_v10',
  NOTIFICATIONS: 'myschool_admin_notifications_v10',
  APPROVALS: 'myschool_admin_approvals_v10',
  LESSON_PROGRESS: 'myschool_admin_lesson_progress_v10',
  STUDENT_LEVEL_SCORES: 'myschool_admin_student_level_scores_v10',
};
